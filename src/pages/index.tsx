...
export default function Home() {
  return (
    <>
      ...
      <main className="bg-home bg-cover bg-center sm:h-screen">
        <div className=" bg-blue-100 bg-opacity-70 px-4 py-6 h-full">
          <section className="max-w-6xl mb-20 mt-3 mx-auto flex justify-center items-center">
            <div className="drop-shadow-xl">
              ...
              <h2 className="text-center mb-4 text-xl sm:text-2xl max-w-xl">
                Organize seus pratos favoritos e acesse todas as suas receitas
